...
# 	-s random-reads.lua http://12.12.12.1:2000 -- 100000 false
# minio
# sudo taskset -c 1-12 ~/tools/wrk/wrk -t240 -c240 -d5s \
# 	-H 'Connection: keep-alive' --latency --timeout 60 \
# 	-s ceph-reads.lua http://12.12.12.2:8080 -- 1000 false
#


# Ceph
sudo taskset -c 1-12 ~/tools/wrk/wrk -t360 -c360 -d1s \
	-H 'Connection: keep-alive' --latency --timeout 60 \
	-s ceph-reads.lua http://12.12.12.2:8080
