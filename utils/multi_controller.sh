...
if [[ $3 == "target" ]]; then
    ...
    if [[ $node == '1' ]]; then
        ./scripts/rpc.py -s /tmp/bdevperf.sock bdev_nvme_attach_controller -b Nvme0 -t tcp -a 192.168.1.149 -s 4420 -f ipv4 -n $ctrl1_nqn -l -1 -o 10
        ./scripts/rpc.py -s /tmp/bdevperf.sock bdev_nvme_attach_controller -b Nvme0 -t tcp -a 192.168.1.149 -s 5520 -f ipv4 -n $ctrl1_nqn -x multipath -l -1 -o 10
        ./scripts/rpc.py -s /tmp/bdevperf.sock bdev_nvme_attach_controller -b Nvme0 -t tcp -a 192.168.1.149 -s 6620 -f ipv4 -n $ctrl1_nqn -x multipath -l -1 -o 10
        ./scripts/rpc.py -s /tmp/bdevperf.sock bdev_nvme_attach_controller -b Nvme0 -t tcp -a 192.168.1.149 -s 7720 -f ipv4 -n $ctrl1_nqn -x multipath -l -1 -o 10

        # ./scripts/rpc.py -s /tmp/bdevperf.sock bdev_nvme_attach_controller -b Nvme1 -t tcp -a 192.168.1.149 -s 6620 -f ipv4 -n $ctrl_nqn -l -1 -o 10
        # ./scripts/rpc.py -s /tmp/bdevperf.sock bdev_nvme_attach_controller -b Nvme1 -t tcp -a 192.168.1.149 -s 7720 -f ipv4 -n $ctrl_nqn -x multipath -l -1 -o 10

    elif [[ $node == '2' ]]; then
        ./scripts/rpc.py -s /tmp/bdevperf.sock bdev_nvme_attach_controller -b Nvme0 -t tcp -a 192.168.1.149 -s 6620 -f ipv4 -n $ctrl1_nqn -l -1 -o 10
        ./scripts/rpc.py -s /tmp/bdevperf.sock bdev_nvme_attach_controller -b Nvme0 -t tcp -a 192.168.1.149 -s 7720 -f ipv4 -n $ctrl1_nqn -x multipath -l -1 -o 10
    elif [[ $node == '3' ]]; then
        echo "pass"
    fi
