...
# sudo taskset -c 12-15 ~/tools/wrk/wrk -t4 -c80 -d5s -s random-reads.lua http://12.12.12.1:2000 -- 100000 false
sudo taskset -c 12-15 ~/tools/wrk/wrk -t8 -c400 -d10s -s random-reads.lua http://12.12.12.1:2000 -- 100000 false
