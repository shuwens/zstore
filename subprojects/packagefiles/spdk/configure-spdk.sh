...
debug() {
  ...
  ./configure --enable-debug --disable-tests --disable-unit-tests --with-shared --with-rdma
}

release() {
  echo '===Building SPDK in release mode...'
  ./configure --disable-tests --disable-unit-tests --with-shared --with-rdma --enable-lto
}
