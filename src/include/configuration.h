  ...
  public:
    ...
    static void PrintConfigurations()
    {
        ...
        const char *systemModeStrs[] = {"ZoneWrite-Only", "ZoneAppend-Only",
                                        "ZapRAID"};
        log_info("ZapRAID Configuration:");
        // log_info("-- Raid mode: {} {} {} --", instance.gStripeDataSize,
        //          instance.gStripeParitySize, instance.gRaidScheme);
        // log_info("-- System mode: {} --",
        //          systemModeStrs[(int)instance.gSystemMode]);
        // log_info("-- GC Enable: {} --", instance.gEnableGc);
    }

    static int GetStripeSize() { return GetInstance().gStripeSize; }

    static int GetStripeDataSize() { return GetInstance().gStripeDataSize; }

    static int GetStripeParitySize() { return GetInstance().gStripeParitySize; }

    static int GetStripeUnitSize() { return GetInstance().gStripeUnitSize; }
    ...
    static void SetStripeDataSize(int stripeDataSize)
    {
        ...
        GetInstance().gStripeSize =
            GetInstance().gStripeDataSize + GetInstance().gStripeParitySize;
    }
    ...
    static int GetStripeGroupSize() { return GetInstance().gStripeGroupSize; }
